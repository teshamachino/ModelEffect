...
binaryClassificationMetrics <- function (estimations, labels, selected_metric = c("ACC", "ERR", "FPR", "TPR", "FNR","TNR","PPV","NPV","F","RPP","RNP"))
...
labels_sort_desc = dataset_labels[order(estimations, decreasing=TRUE)]


# using ROCR package create prediction S4 object
pred <- ROCR::prediction(estimations, dataset_labels)
